...
const dropdownMenuContentVariants = cva(
  "z-50 overflow-hidden rounded-md border border-border bg-card p-1 text-card-foreground shadow-md outline-none duration-200",
  {
    variants: {
      size: {
        default: "min-w-40",
...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent
    ref={ref}
    className={cn(
      "z-50 min-w-40 overflow-hidden rounded-md border border-border bg-card p-1 text-card-foreground shadow-md outline-none duration-200",
      className,
    )}
    {...props}
  />
